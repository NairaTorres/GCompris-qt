...
GridView {
    ...
    /**
     * Armazena o índice do item que é clicado para editar.
     *
     * Se o índice do item no segundo clique for o mesmo que initialEditItemIndex, o indicador ficará invisível, pois isso significa que inicialmente você queria editar essa instrução, mas agora queremos desmarcá-la.
     *
     * Se o índice do item no segundo clique for diferente de initialEditItemIndex, o indicador de edição será movido para o novo item, como agora queremos editar esse.
     */
    ...
    function appendInstruction() {
        if(background.insertIntoMain || (instructionArea.instructionToInsert != "call-procedure") || (instructionArea.instructionToInsert != "loop-code")) {
    ...
    delegate: Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                Image {
                    id: codeAreaIcon
                    source: "qrc:/gcompris/src/activities/programing_loop/resource/" + name + ".svg"
